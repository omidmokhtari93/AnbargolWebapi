...
namespace AbnbarGolWebService.Controllers
{
    ...
    public class GetControlsController : ApiController
    {
        ...
        public IHttpActionResult Get()
        {
            ...
            var cm = new SqlCommand("select item_id as Value ,item_name as name FROM items where item_id <> 0 order by item_name " +
                                    ...
                                    "select company_id  as Value, company_name as name from flower_companies", con);
